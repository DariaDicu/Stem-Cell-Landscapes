...
GLVisualize.view(copy(cat), camera_screen, camera=:perspective)

GLVisualize.view(copy(cat), scene_screen, camera=:perspective)

GLVisualize.view(visualize(cam), scene_screen, camera=:perspective)

GLVisualize.view(camera_points, scene_screen, camera=:perspective)
GLVisualize.view(camera_path_line, scene_screen, camera=:perspective)
